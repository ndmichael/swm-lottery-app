...
class Bronze(models.Model):
    ...
    def save(self, *args, **kwargs):
        self.enddate = self.startdate + timedelta(hours=1, minutes=0)
...
class Jackpot(models.Model):
    ...
    def save(self, *args, **kwargs):
        self.enddate = self.startdate + timedelta(hours=3, minutes=0)
        super().save(*args, **kwargs)
...
class Megawin(models.Model):
    ...
    def save(self, *args, **kwargs):
        self.enddate = self.startdate + timedelta(hours=6, minutes=0)
        super().save(*args, **kwargs)
